...
class TestResponseFormatConsistency:
    ...
    def test_fix_note_response_schema(self, note_1):
        ...
        """
        required_fields = [
            "id", "user_id", "title", "timestamp", 
            "updated_at", "priority", "is_archived", "is_deleted"
        ]
...
class TestArchiveValidation:
    ...
    def test_fix_prevent_archive_with_active_high_priority_task(self, note_1, high_priority_task):
        """
        ...
        def update_note_archive(note: dict, update_data: dict, tasks: list) -> dict:
            ...
            if update_data.get("is_archived") is True and not note.get("is_archived", False):
                ...
                if active_high_priority:
                    raise ValueError("Cannot archive note with active HIGH priority tasks")
        ...
        result = update_note_archive(note_1.copy(), {"is_archived": True}, [completed_task])
