...
class TestAudioQuality:
    ...
    def test_quality_metrics_completeness_103(self):
        ...
        if os.path.exists(path):
            ...
            expected_metrics = [
                'loudness_rms', 'loudness_db', 'snr_db',
                'clipping_percentage', 'spectral_flatness_mean',
                'zero_crossing_rate_mean', 'speech_activity_ratio',
                'silence_ratio', 'duration_seconds', 'sample_rate',
