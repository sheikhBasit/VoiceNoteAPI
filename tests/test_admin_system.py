...
class TestAdminRoleAssignment:
    ...
    def test_revoke_admin_role(self, db_session):
        ...
        updated_user = AdminManager.revoke_admin_role(
            db=db_session, user_id="test_admin_001"
        )
...
class TestPermissionChecking:
    ...
    def test_is_admin_check(self, db_session):
        """Test is_admin check"""
        admin_user = models.User(
            id="admin_001", name="Admin", email="admin@example.com", is_admin=True
        )
        regular_user = models.User(
            id="user_001", name="User", email="user@example.com", is_admin=False
        )
    ...
    def test_has_any_permission(self, db_session):
        ...
        has_perm = AdminManager.has_any_permission(
            moderator, ["can_delete_users", "can_moderate_content"]
        )
        assert has_perm is True

        has_perm = AdminManager.has_any_permission(
            moderator, ["can_delete_users", "can_manage_admins"]
        )
    ...
    def test_has_all_permissions(self, db_session):
        ...
        has_all = AdminManager.has_all_permissions(
            admin_user, ["can_delete_users", "can_view_all_notes", "can_manage_admins"]
        )
        assert has_all is True

        has_all = AdminManager.has_all_permissions(
            admin_user, ["can_delete_users", "nonexistent_perm"]
        )
...
class TestPermissionUpdate:
    ...
    def test_update_permissions_add(self, db_session):
        ...
        updated = AdminManager.update_permissions(
            db=db_session, user_id="admin_001", permissions={"can_delete_users": True}
        )
    ...
    def test_update_permissions_revoke(self, db_session):
        ...
        updated = AdminManager.update_permissions(
            db=db_session, user_id="admin_001", permissions={"can_delete_users": False}
        )
...
class TestAdminActionLogging:
    ...
    def test_log_admin_action(self, db_session):
        ...
        target_user = models.User(
            id="user_001", name="Target User", email="target@example.com"
        )
    ...
    def test_log_make_admin_action(self, db_session):
        ...
        target_user = models.User(
            id="user_002", name="Target User", email="target2@example.com"
        )
        db_session.add_all([admin_user, target_user])
        db_session.commit()
...
class TestAdminDataAccess:
    ...
    def test_admin_can_delete_any_user(self, db_session):
        ...
        user = models.User(
            id="user_001", name="User", email="user@example.com", is_deleted=False
        )
...
class TestAdminTimestamps:
    ...
    def test_admin_created_at_set_on_grant(self, db_session):
        ...
        user = (
            db_session.query(models.User).filter(models.User.id == "user_001").first()
        )
    ...
    def test_admin_last_action_updated(self, db_session):
        ...
        admin_user = (
            db_session.query(models.User).filter(models.User.id == "admin_001").first()
        )
