...
class TestUsersAuthentication:
    ...
    def test_01_sync_user_new_account(self):
        ...
        response = requests.post(f"{BASE_URL}/users/sync", json=payload, timeout=10)
    ...
    def test_04_sync_missing_device_id(self):
        ...
        assert (
            response.status_code == 400
        ), f"Expected 400 for empty device_id, got {response.status_code}"
...
class TestUsersProfileManagement:
    ...
    def test_06_get_user_profile_by_id(self):
        ...
        response = requests.get(f"{BASE_URL}/users/{test_data['user_id']}", timeout=10)
    ...
    def test_07_get_nonexistent_user(self):
        ...
        response = requests.get(f"{BASE_URL}/users/{fake_id}", timeout=10)
    ...
    def test_09_update_profile_invalid_work_hours(self):
        ...
        assert (
            response.status_code == 400
        ), f"Expected 400 for invalid hours, got {response.status_code}"
...
class TestUsersSearch:
    ...
    def test_10_search_users_by_name(self):
        ...
        response = requests.get(
            f"{BASE_URL}/users/search?query={TEST_NAME}", timeout=10
        )
    ...
    def test_11_search_users_by_email(self):
        ...
        response = requests.get(
            f"{BASE_URL}/users/search?query={test_data['user_email']}", timeout=10
        )
    ...
    def test_12_search_with_pagination(self):
        ...
        response = requests.get(f"{BASE_URL}/users/search?skip=0&limit=10", timeout=10)
...
class TestUsersDeletion:
    ...
    def test_14_verify_user_deleted(self):
        ...
        ), f"Deleted user should return 404, got {response.status_code}"
    ...
    def test_15_cannot_hard_delete_via_me(self):
        ...
        response = requests.delete(
            f"{BASE_URL}/users/me?hard=true", headers=headers, timeout=10
        )
...
class TestUsersAuthentication2:
    ...
    def test_16_logout_user(self):
        ...
        sync_response = requests.post(
            f"{BASE_URL}/users/sync", json=payload, timeout=10
        )
        ...
        response = requests.post(
            f"{BASE_URL}/users/logout", headers=headers, timeout=10
        )
