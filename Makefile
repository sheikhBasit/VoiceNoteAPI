...
test:
	...
	$(COMPOSE) run --rm $(API_SERVICE) pytest tests/ -v

test-admin:
	@echo "🧪 Running admin system tests..."
	$(COMPOSE) run --rm $(API_SERVICE) pytest tests/test_admin_system.py -v

test-coverage:
	@echo "🧪 Running tests with coverage..."
	$(COMPOSE) run --rm $(API_SERVICE) pytest tests/ --cov=app --cov-report=html --cov-report=term
