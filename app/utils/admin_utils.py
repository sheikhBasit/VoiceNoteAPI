...
class AdminManager:
    ...
    @staticmethod
    def grant_admin_role(db: Session, user_id: str, granted_by: str, 
                        permission_level: str = "full") -> models.User:
        """
    ...
    @staticmethod
    def update_permissions(db: Session, user_id: str, 
                          permissions: Dict[str, bool]) -> models.User:
