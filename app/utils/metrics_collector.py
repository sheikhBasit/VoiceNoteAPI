...
class MetricsCollector:
    ...
    def end_timer(self, name: str, metadata: Dict[str, Any] = None) -> float:
        ...
        self.record_metric(
            metric_name=name, value=duration, unit="seconds", metadata=metadata or {}
        )

        return duration

    def record_metric(
        self, metric_name: str, value: float, unit: str, metadata: Dict[str, Any] = None
    ):
    ...
    def get_summary(self) -> Dict[str, Any]:
        ...
        for name, values in grouped.items():
            ...
            summary[name] = {
                ...
                "total": sum(values),
                "unit": next(
                    (m.unit for m in self.metrics if m.metric_name == name), ""
                ),
            }
