...
DATABASE_URL = os.getenv(
    "DATABASE_URL", "postgresql://postgres:password@db:5432/voicenote"
)
...
if DATABASE_URL.startswith("sqlite"):
    ...
    clean_url = DATABASE_URL.replace("postgresql+asyncpg://", "postgresql://").replace(
...
if (
    "sqlite" not in ASYNC_DATABASE_URL
    or os.getenv("USE_ASYNCSQLITE", "false") == "true"
):
    try:
