...
class ComprehensiveTestSuite:
    ...
    def create_test_audio_file(self):
        ...
        try:
            ...
            if os.path.exists(audio_path):
                ...
                self.log_test("Audio File Creation", "PASS",
                             f"Created {audio_path} ({size} bytes)",
                             time.time() - start_time)
                return audio_path
            else:
                self.log_test("Audio File Creation", "FAIL",
                             "File not created", time.time() - start_time)
                return None
                
        except Exception as e:
            self.log_test("Audio File Creation", "FAIL", str(e),
                         time.time() - start_time)
            return None
    ...
    def test_list_notes(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.log_test("GET /notes (List)", "PASS",
                             f"Retrieved {count} notes", time.time() - start_time)
                return True
            else:
                self.log_test("GET /notes (List)", "FAIL",
    ...
    def test_search_notes(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.log_test("POST /notes/search", "PASS",
                             f"Found {count} results", time.time() - start_time)
                return True
            else:
                self.log_test("POST /notes/search", "FAIL",
                             f"Status {response.status_code}", time.time() - start_time)
                return False
        except Exception as e:
            self.log_test("POST /notes/search", "FAIL", str(e), time.time() - start_time)
            return False
    ...
    def test_get_dashboard_metrics(self):
        ...
        try:
            ...
            if response.status_code == 200:
                self.log_test("GET /notes/dashboard", "PASS",
                             "Retrieved dashboard", time.time() - start_time)
                return True
            else:
                self.log_test("GET /notes/dashboard", "FAIL",
                             f"Status {response.status_code}", time.time() - start_time)
                return False
        except Exception as e:
            self.log_test("GET /notes/dashboard", "FAIL", str(e), time.time() - start_time)
            return False
    ...
    def test_create_task(self):
        ...
        try:
            ...
            if response.status_code in [200, 201]:
                ...
                self.log_test("POST /tasks (Create)", "PASS",
                             f"Created task {task_id}", time.time() - start_time)
                return task_id
            else:
                self.log_test("POST /tasks (Create)", "FAIL",
                             f"Status {response.status_code}", time.time() - start_time)
                return None
        except Exception as e:
            self.log_test("POST /tasks (Create)", "FAIL", str(e), time.time() - start_time)
            return None
    ...
    def test_list_tasks(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.log_test("GET /tasks (List)", "PASS",
                             f"Retrieved {count} tasks", time.time() - start_time)
                return True
            else:
                self.log_test("GET /tasks (List)", "FAIL",
                             f"Status {response.status_code}", time.time() - start_time)
                return False
        except Exception as e:
    ...
    def test_get_task(self, task_id):
        ...
        try:
            ...
            if response.status_code == 200:
                self.log_test("GET /tasks/{task_id}", "PASS",
                             "Retrieved task", time.time() - start_time)
                return True
            else:
                self.log_test("GET /tasks/{task_id}", "FAIL",
                             f"Status {response.status_code}", time.time() - start_time)
                return False
        except Exception as e:
            self.log_test("GET /tasks/{task_id}", "FAIL", str(e), time.time() - start_time)
            return False
    ...
    def test_update_task(self, task_id):
        ...
        try:
            ...
            if response.status_code == 200:
                self.log_test("PATCH /tasks/{task_id}", "PASS",
                             "Updated task", time.time() - start_time)
                return True
            else:
                self.log_test("PATCH /tasks/{task_id}", "FAIL",
                             f"Status {response.status_code}", time.time() - start_time)
                return False
        except Exception as e:
            self.log_test("PATCH /tasks/{task_id}", "FAIL", str(e), time.time() - start_time)
            return False
    ...
    def test_search_tasks(self):
        ...
        try:
            ...
            if response.status_code == 200:
                results = response.json()
                count = len(results) if isinstance(results, list) else 0
                self.log_test("GET /tasks/search", "PASS",
                             f"Found {count} tasks", time.time() - start_time)
                return True
            else:
                self.log_test("GET /tasks/search", "FAIL",
                             f"Status {response.status_code}", time.time() - start_time)
                return False
        except Exception as e:
    ...
    def test_get_task_stats(self):
        ...
        try:
            ...
            if response.status_code == 200:
                self.log_test("GET /tasks/stats", "PASS",
                             "Retrieved stats", time.time() - start_time)
                return True
            else:
                self.log_test("GET /tasks/stats", "FAIL",
                             f"Status {response.status_code}", time.time() - start_time)
                return False
        except Exception as e:
    ...
    def test_get_due_today(self):
        ...
        try:
            ...
            if response.status_code == 200:
                tasks = response.json()
                count = len(tasks) if isinstance(tasks, list) else 0
                self.log_test("GET /tasks/due-today", "PASS",
                             f"Found {count} tasks", time.time() - start_time)
                return True
            else:
                self.log_test("GET /tasks/due-today", "FAIL",
                             f"Status {response.status_code}", time.time() - start_time)
                return False
        except Exception as e:
            self.log_test("GET /tasks/due-today", "FAIL", str(e), time.time() - start_time)
            return False
    ...
    def test_get_overdue_tasks(self):
        ...
        try:
            ...
            if response.status_code == 200:
                tasks = response.json()
                count = len(tasks) if isinstance(tasks, list) else 0
                self.log_test("GET /tasks/overdue", "PASS",
                             f"Found {count} tasks", time.time() - start_time)
                return True
            else:
                self.log_test("GET /tasks/overdue", "FAIL",
                             f"Status {response.status_code}", time.time() - start_time)
                return False
        except Exception as e:
            self.log_test("GET /tasks/overdue", "FAIL", str(e), time.time() - start_time)
            return False
    ...
    def test_duplicate_task(self, task_id):
        ...
        try:
            ...
            if response.status_code in [200, 201]:
                ...
                self.log_test("POST /tasks/{task_id}/duplicate", "PASS",
                             f"Duplicated task {dup_id}", time.time() - start_time)
                self.tasks_created.append(dup_id)
                return True
            else:
                self.log_test("POST /tasks/{task_id}/duplicate", "FAIL",
                             f"Status {response.status_code}", time.time() - start_time)
                return False
        except Exception as e:
            self.log_test("POST /tasks/{task_id}/duplicate", "FAIL", str(e), time.time() - start_time)
            return False
    ...
    def test_delete_task(self, task_id):
        ...
        try:
            ...
            if response.status_code in [200, 204]:
                self.log_test("DELETE /tasks/{task_id}", "PASS",
                             "Deleted task", time.time() - start_time)
                return True
            else:
                self.log_test("DELETE /tasks/{task_id}", "FAIL",
                             f"Status {response.status_code}", time.time() - start_time)
                return False
        except Exception as e:
            self.log_test("DELETE /tasks/{task_id}", "FAIL", str(e), time.time() - start_time)
            return False
    ...
    def run_all_tests(self):
        ...
        print("\n")
        print("╔" + "="*68 + "╗")
        print("║" + " "*12 + "COMPREHENSIVE API TEST SUITE - NOTES & TASKS" + " "*13 + "║")
        print("║" + " "*68 + "║")
        print("║" + f"  Date: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}" + " "*42 + "║")
        print("╚" + "="*68 + "╝")
